        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SavedListsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemSavedList", x => new { x.ItemId, x.SavedListsId });
                    table.ForeignKey(
                        name: "FK_ItemSavedList_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemSavedList_SavedLists_SavedListsId",
                        column: x => x.SavedListsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemSavedList_SavedListsId",
                table: "ItemSavedList",
                column: "SavedListsId");
